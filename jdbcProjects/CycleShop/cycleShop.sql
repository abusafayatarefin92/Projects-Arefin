...
INSERT INTO `cyclepurchase` (`id`,`name`,`pCode`,`quantity`,`unitPrice`,`totalPrice`,`purchaseDate`) VALUES 
 ...
 (5,'Core Project 2','CORE02',10,22000,220000,'2018-12-04'),
 (6,'Core Project 2','CORE02',10,22000,220000,'2018-12-04'),
 (7,'Talus 2','TALUS02',10,21000,210000,'2018-12-04'),
 (8,'Talus 2','TALUS02',10,21000,210000,'2018-12-04');
...
INSERT INTO `cyclesales` (`id`,`name`,`pCode`,`quantity`,`unitPrice`,`totalPrice`,`salesDate`,`pId`) VALUES 
 ...
 (3,'Core Project 2','CORE02',5,24200,121000,'2018-12-04',5),
 (4,'Core Project 2','CORE02',5,24200,121000,'2018-12-04',5),
 (5,'Talus 2','TALUS02',5,23100,115500,'2018-12-04',7);
...
INSERT INTO `purchasesalessummary` (`id`,`name`,`pCode`,`totalQuantity`,`soldQuantity`,`availableQuantity`,`lastUpdate`,`pId`) VALUES 
 ...
 (4,'Core Project 2','CORE02',20,10,10,'2018-12-04',5),
 (5,'Talus 2','TALUS02',20,5,15,'2018-12-04',7);
